...
\* I would like to rename this. This is not a README. this is a test harness. *\
...
(define results
  -> (let Passed (trap-error (value *passed*) (/. E 0))
          ...
          (output "~%passed ... ~A~%failed ...~A~%pass rate ...~A%~%~%" Passed Failed Percent)))     ) \* I'd like this to report the (report) suite *\
